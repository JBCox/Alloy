...
preset card + its warning modal) is Build Together with the three brakes off.
...
- **One loop now** (was: two duplicated loops, extracted 2026-08-16):
  ...
  tests — see `tests/` (1149 tests across 51 suites, all runnable as plain scripts, or `python tests/run_all.py` for the lot).
...
**Token-free first**: `tests/` holds 1149 tests across 51 suites (plus three

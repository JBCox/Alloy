...
- **One loop now** (was: two duplicated loops, extracted 2026-08-16):
  ...
  tests — see `tests/` (2182 tests across 69 suites, all runnable as plain scripts, or `python tests/run_all.py` for the lot).
...
**Token-free first**: `tests/` holds 2182 tests across 69 suites (plus three

...
- **One loop now** (was: two duplicated loops, extracted 2026-08-16):
  ...
  tests — see `tests/` (1951 tests across 65 suites, all runnable as plain scripts, or `python tests/run_all.py` for the lot).
...
**Token-free first**: `tests/` holds 1951 tests across 65 suites (plus three

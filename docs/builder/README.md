...
| [launching.md](launching.md) | The CLI (`python -m builder`, `builder.cmd`), the Model Builder view in the app (the cube button in the app nav), launch scripts, and what each entry point refuses to do on its own. |
...
- The same flow runs in the app's Model Builder view: `python app.py`, then the cube button in the app nav (see [launching.md](launching.md)).
